...
export default function Home() {
  return (
    <>
      <Header />
      <HeroSection />
      <section className="go-calc section" id="go-calculator" aria-labelledby="calc-title">
        <div className="container go-calc__wrap">
          <div className="go-calc__card">
            ...
            <div className="go-calc__row">
              <div>
                <label htmlFor="go-per-price">Trenutna cijena po isporuci (€)</label>
                <input id="go-per-price" type="number" readOnly defaultValue="120" inputMode="numeric" />
                <div className="help">Marginalne stope: <span id="go-per-range">1–20: 150 • 21–30: 100 • 31+: 70</span></div>
              </div>
              <div>
                <label htmlFor="go-adhoc">Ad-hoc usporedba (€ / isporuka)</label>
                <input id="go-adhoc" type="number" defaultValue="220" inputMode="numeric" readOnly />
                <div className="help">Ad-hoc = jednokratni kratki video/foto bez pretplate i arhive</div>
              </div>
            </div>
      ...
      <Calculator />
      <div className="curved-element"></div>
      <div className="content">Scroll down to see morphing effect</div>
    </>
  );
}